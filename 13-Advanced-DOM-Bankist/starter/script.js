...
const slider = function () {
  ...
  // slider.style.transform = 'scale(0.38) translateX(-800px)';
  ...
  // Event delegation for the dots, so that we don't have an eventlistener to each dot!
...
// const boundGetX = unboundGetX.bind({ x });
// console.log(boundGetX());
...
// DON'T DO THIS MANY TIMES!!! PRETTY INTRUSIVE STUFF INDEED
